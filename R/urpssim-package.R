...
utils::globalVariables(c(
  ...
  "age",
  "age_group",
  "age_hwsm", "age_max", "age_min",
  "agent_id",
  "appointment_date", "appointment_date_text",
  "appointment_obtained", "appointment_pct",
  "call_date", "call_date_text", "call_year",
  "census_division",
  "clinical_fte",
  "clinical_scenario",
  "contacted_first", "contacted_second",
  "convergence",
  "demand_workload",
  "embedded_record_id",
  "exclusion_reason",
  "excluded",
  "exit_draw",
  "fitted_adequacy", "fitted_days", "fitted_error_days",
  "hours_per_week",
  "insurance",
  "mean_adequacy",
  "medicaid_status_text",
  "n",
  "npi",
  "observed_days",
  "pathway",
  "peak_hrs",
  "phone",
  "physician_code", "physician_information", "physician_name",
  "prob_exit",
  "reached_office",
  "reference_days", "reference_error_days",
  "relative_fte",
  "sex",
  "sex_clean",
  "sex_hwsm",
