...
#
# build_swan_incontinence_panel() (R/data-swan_incontinence_panel) harmonises the incontinence ITEMS, and
# dmdm_transition_data() (R/demand-dmdm_fit_transitions) consumes a person-year panel of STATES plus
# covariates. Nothing joined the two: R/data-swan_incontinence_panel returns swan_id/visit/leakage_ever/
# severity, while R/demand-dmdm_fit_transitions requires person_id, year, and seven covariates. This
...
# is emitted as a constant so the panel satisfies R/demand-dmdm_fit_transitions's column contract; a
