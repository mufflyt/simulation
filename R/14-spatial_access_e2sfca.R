...
#' propagation, NOT the microsimulation replicate-quantile band -- a different
#' quantity (see the SSOT coverage note); `mufflyaccess` may own a canonical
#' variant. The caller's RNG stream is saved and restored.
#'
#' @param access Numeric accessibility values.
