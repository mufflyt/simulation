...
#
#   urps_count()                base-year supply           ALREADY WIRED (R/supply-provider_lifecycle)
...
#   match the SSOT boundary exactly (see R/demand-urps).
#
...
ssot_coverage_report <- function() {
  tibble::tribble(
    ...
    "PFD prevalence <65",         "local",         "NOT in the contract; Nygaard-derived literals in R/demand-urps",
