...
#
# WHY THIS EXISTS
# The DMDM (demand-dynamic_multistate / demand-dynamic_open / demand-dmdm_fit_transitions) treats every condition as a two-state (present/absent)
...
#
# Until a longitudinal POP panel is fitted (via R/demand-dmdm_fit_transitions), this module supplies a
