...
# (R/calibration-validation) is wired into the orchestrator to stop the tautology returning.
#
...
#' estimate a shortage. See R/reporting-baseline_gap.R for the absolute level.
#'
