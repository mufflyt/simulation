...
#'
#' @export
# [deduplicated] update_dpmm_with_literature_severity(): identical earlier definition removed; the surviving definition is below.

#' Detect Available SWAN Urinary Incontinence Variables
#' @noRd
# [deduplicated] detect_swan_urinary_variables(): identical earlier definition removed; the surviving definition is below.

#' Analyze Visit Data Completeness for Sandvik Calculation
#' @noRd
# [deduplicated] analyze_visit_data_completeness(): identical earlier definition removed; the surviving definition is below.

#' Apply Sandvik Severity Index Assessment
#' @noRd
# [disambiguated] was a second, DIVERGENT definition of apply_sandvik_severity_assessment(); renamed to
# apply_sandvik_severity_assessment_variant1() so it no longer silently shadows the definition below. Verify which is wanted.
apply_sandvik_severity_assessment_variant1 <- function(swan_dataset, available_variables, verbose_logging = TRUE) {
...
#' @noRd
# [deduplicated] apply_iciq_severity_assessment(): identical earlier definition removed; the surviving definition is below.

#' Apply Custom Severity Assessment
#' @noRd
# [deduplicated] apply_custom_severity_assessment(): identical earlier definition removed; the surviving definition is below.
