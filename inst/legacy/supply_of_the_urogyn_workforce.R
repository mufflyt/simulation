...
#' @export
# [disambiguated] was a second, DIVERGENT definition of analyze_urogynecology_workforce(); renamed to
# analyze_urogynecology_workforce_variant1() so it no longer silently shadows the definition below. Verify which is wanted.
analyze_urogynecology_workforce_variant1 <- function(census_file_path,
                                            initial_workforce_count = 1169,
                                            baseline_new_fellows = 55,
                                            baseline_retirements = 55,
                                            visits_per_woman_annually = 1.5,
...
#' @noRd
# [deduplicated] process_census_population_data(): identical earlier definition removed; the surviving definition is below.
...
#' @noRd
# [deduplicated] calculate_workforce_demand(): identical earlier definition removed; the surviving definition is below.
...
#' @noRd
# [disambiguated] was a second, DIVERGENT definition of simulate_workforce_scenarios(); renamed to
# simulate_workforce_scenarios_variant1() so it no longer silently shadows the definition below. Verify which is wanted.
simulate_workforce_scenarios_variant1 <- function(projection_years,
...
#' @noRd
# [deduplicated] simulate_single_supply_scenario(): identical earlier definition removed; the surviving definition is below.
...
#' @noRd
# [disambiguated] was a second, DIVERGENT definition of calculate_workforce_gaps(); renamed to
# calculate_workforce_gaps_variant1() so it no longer silently shadows the definition below. Verify which is wanted.
calculate_workforce_gaps_variant1 <- function(supply_data, demand_data, verbose = TRUE) {
...
#' @noRd
# [disambiguated] was a second, DIVERGENT definition of create_workforce_visualizations(); renamed to
# create_workforce_visualizations_variant1() so it no longer silently shadows the definition below. Verify which is wanted.
create_workforce_visualizations_variant1 <- function(supply_data, demand_data, gap_data,
...
#' @noRd
# [deduplicated] generate_summary_statistics(): identical earlier definition removed; the surviving definition is below.
...
census_file_path <- data_raw_path("np2023-t2.xlsx")
...
#' @return Data frame with processed population projections
#' @noRd
# [disambiguated] was a second, DIVERGENT definition of process_census_population_data(); renamed to
# process_census_population_data_variant2() so it no longer silently shadows the definition below. Verify which is wanted.
process_census_population_data_variant2 <- function(census_file_path, verbose = TRUE) {
