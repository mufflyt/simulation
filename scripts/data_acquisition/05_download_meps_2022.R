...
#        data-raw/meps/meps_2022_ui_visit_rates.rds
#        data-raw/meps/meps_2022_income_care_seeking_multipliers.rds
#        data-raw/meps/meps_2022_manifest.txt
#
...
#   data-raw/meps/meps_2022_ui_visit_rates.rds
#   data-raw/meps/meps_2022_income_care_seeking_multipliers.rds
#   data-raw/meps/meps_2022_insurance_care_seeking_multipliers.rds
#   data-raw/meps/meps_2022_specialty_distribution.rds
#   data-raw/meps/meps_2022_manifest.txt
#
# KEY ICD-10 CODES:
...
rds_visits  <- file.path(out_dir, "meps_2022_ui_visit_rates.rds")
rds_income  <- file.path(out_dir, "meps_2022_income_care_seeking_multipliers.rds")
rds_insur   <- file.path(out_dir, "meps_2022_insurance_care_seeking_multipliers.rds")
rds_spec    <- file.path(out_dir, "meps_2022_specialty_distribution.rds")
...
message("# Source: scripts/data_acquisition/05_download_meps_2022.R")
message("#' @export")
...
manifest_path <- file.path(out_dir, "meps_2022_manifest.txt")
writeLines(c(
  ...
  "",
  "Files:",
  paste("  meps_2022_ui_visit_rates.rds            — visit totals by age/insurance/income/specialty"),
  paste("  meps_2022_income_care_seeking_multipliers.rds  — named vector, GT100k=1.0 reference"),
  paste("  meps_2022_insurance_care_seeking_multipliers.rds — named vector, Private=1.0 reference"),
  paste("  meps_2022_specialty_distribution.rds    — share of visits by provider specialty"),
  "",
...
message("Done. MEPS 2022 download and recalibration complete.")
message("Next step: apply the patch printed above to R/44-urps_population.R,")
message("  or call apply_meps_2022_recalibration() once that function is added.")
